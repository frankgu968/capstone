         ...
         return (
              <div className="App">
                ...
                <div id="ModeSelect">
                    ...
                    <ButtonGroup>
                        <Button active={this.state.runMode===0} disabled={!(this.state.status===-1) && !(this.state.runMode===0)}>
                            Auto
                        </Button>
                        <Button active={this.state.runMode===1} disabled={!(this.state.status===-1) && !(this.state.runMode===1)}>
                            Step
                        </Button>
                    </ButtonGroup>
                </div>
                ...
                <div id="ButtonStart">
                    <Button onClick={() => this.onStepClick()} block disabled>
                        {this.state.runMode===0 ? "Start" : "Step"}
                    </Button>
                </div>

                <div id="ButtonReset">
                    <Button onClick={() => this.onResetClick()} block disabled>
                        Reset
                    </Button>
                </div>
